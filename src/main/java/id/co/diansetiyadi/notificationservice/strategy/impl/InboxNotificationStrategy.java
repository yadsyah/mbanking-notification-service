...
public class InboxNotificationStrategy implements NotificationStrategy {
    ...
    @Autowired
    public InboxNotificationStrategy(KafkaNotificationService kafkaNotificationService) {
    ...
    public void sendMessage(String message) {
        ...
        kafkaNotificationService.sendMessage(TopicProducer.NOTIFICATION_INBOX, message);
    }
